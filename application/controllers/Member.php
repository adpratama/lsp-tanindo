...
class Member extends CI_Controller
{
  ...
  //   $member = $this->db->order_by('uid', 'DESC')->get('profil')->result();
  ...
  //     $excel->getProperties()->setCreator('lsp tanindo')
  //       // ->setLastModifiedBy('lsp tanindo')
  //       ->setTitle("REport Data KTNA");
  //     // ->setSubject("Stok")
  ...
  //     $excel->setActiveSheetIndex(0)->setCellValue('G1', "Nomor Hp");
  ...
  //       $excel->setActiveSheetIndex(0)->setCellValue('B' . $numrow, $t->nomor_urut);
  //       $excel->setActiveSheetIndex(0)->setCellValue('C' . $numrow, $t->full_name);
  //       $excel->setActiveSheetIndex(0)->setCellValue('D' . $numrow, $t->email);
  //       $excel->setActiveSheetIndex(0)->setCellValue('E' . $numrow, $t->jabatan);
  //       $excel->setActiveSheetIndex(0)->setCellValue('F' . $numrow, $t->alamat);
  //       $excel->setActiveSheetIndex(0)->setCellValue('G' . $numrow, $t->phone_number);
  ...
  //     // $excel->setActiveSheetIndex(0)->mergeCells('A' . $numrow . ':G' . $numrow);
  ...
  //     header('Content-Disposition: attachment;filename="Report_data.xls"');
  ...
  //     exit;
  //   } else {
  //     $this->session->set_flashdata('message_error', 'There is no data between ');
  //   }
